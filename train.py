...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[7000])#default=[7000, 30_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[7000])#default=[7000, 30_000])
